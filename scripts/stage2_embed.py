...
절차 (`.claude/skills/runpod_session/SKILL.md` ②③④):
    ...
    3. runpodctl send scripts/_work/_stage2_chunks.jsonl scripts/stage2_embed.py
    ...
    4. 로컬로 emb.npy 회수 -> python scripts/stage2_embed.py load --npy emb.npy
    5. 🔴 사용자에게 묻고 runpod_pod.py close

실행:
    python scripts/stage2_embed.py pod  --in _stage2_chunks.jsonl --out emb.npy
    PYTHONIOENCODING=utf-8 python scripts/stage2_embed.py load --npy emb.npy
    PYTHONIOENCODING=utf-8 python scripts/stage2_embed.py load --npy emb.npy --cpu-fallback
"""
