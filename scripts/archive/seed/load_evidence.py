...
실행:
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/load_evidence.py
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/load_evidence.py --diff   # rules.증빙 과 대조만
"""
