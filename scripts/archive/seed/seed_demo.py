...
"""시연용 기관 1건 + 계정 1건을 심는다. **멱등** — 두 번 돌려도 중복이 안 생긴다.
    ...
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/seed_demo.py --email 심사용@example.com
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/seed_demo.py --email ... --dsn <운영DSN> --운영승인
