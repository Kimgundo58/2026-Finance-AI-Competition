...
실행:
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/normalize_refs.py            # dry-run
    PYTHONIOENCODING=utf-8 python scripts/archive/seed/normalize_refs.py --apply
"""
