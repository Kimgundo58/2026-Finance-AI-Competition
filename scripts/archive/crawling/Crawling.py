# -*- coding: utf-8 -*-
"""중소벤처기업진흥공단 창업지원(start.kosmes.or.kr) FAQ 전량 크롤러 — kosmes_data/kosmes_faq.json 출력.

FAQ 목록은 listFrm 폼을 pageIndex 만 바꿔 POST 하면 완성된 HTML 이 온다.

    python scripts/archive/crawling/Crawling.py
"""
