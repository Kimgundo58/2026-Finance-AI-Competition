...
실행
────
    PYTHONIOENCODING=utf-8 python scripts/archive/indexing/stage2_cases.py check
    PYTHONIOENCODING=utf-8 python scripts/archive/indexing/stage2_cases.py extract
    PYTHONIOENCODING=utf-8 python scripts/archive/indexing/stage2_cases.py embed
    PYTHONIOENCODING=utf-8 python scripts/archive/indexing/stage2_cases.py load
    PYTHONIOENCODING=utf-8 python scripts/archive/indexing/stage2_cases.py all
"""
...
def cmd_check(a) -> None:
    ...
    OUT_AUDIT.write_text(json.dumps({
        "생성": "F세션 2026-08-31 · scripts/archive/indexing/stage2_cases.py check",
