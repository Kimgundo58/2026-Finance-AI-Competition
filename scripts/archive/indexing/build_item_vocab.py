...
실행:
    python scripts/archive/indexing/build_item_vocab.py
    python scripts/archive/indexing/build_item_vocab.py --check   파일 안 쓰고 대조만
"""
...
def main() -> None:
    ...
    doc = {
        "생성": "scripts/archive/indexing/build_item_vocab.py",
        "사양": "rule_base.md §1-b",
        "코퍼스_스냅샷": {
            "문서수": len(arts),
