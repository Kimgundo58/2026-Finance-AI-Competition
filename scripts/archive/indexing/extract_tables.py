...
실행:
    python scripts/archive/indexing/extract_tables.py                전체 (L2)
    python scripts/archive/indexing/extract_tables.py --doc 예비창업   일부
"""
...
def run(doc_filter: str | None, all_docs: bool) -> None:
    ...
    doc = {
        "생성": "scripts/archive/indexing/extract_tables.py",
        "설정": TABLE_SETTINGS,
