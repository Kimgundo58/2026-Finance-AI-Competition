...
실행:
    python scripts/archive/indexing/stage0_run.py              전체
    python scripts/archive/indexing/stage0_run.py --only L2    L2 만
    python scripts/archive/indexing/stage0_run.py --limit 20   앞 20건 (연습용)
"""
...
def main() -> None:
    ...
    el = time.time() - t0
    report["요약"] = {
        "생성": "scripts/archive/indexing/stage0_run.py",
