...
실행:
    python scripts/archive/indexing/build_precedence.py            추출 + 저장
    python scripts/archive/indexing/build_precedence.py --show     결과만 출력
"""
...
def main() -> None:
    ...
    doc = {
        "생성": "scripts/archive/indexing/build_precedence.py",
        "기준일": "2026-08-27",
