...
못 넘으면 UI 는 의미가 없다).
    ...
    PYTHONIOENCODING=utf-8 python scripts/archive/cli/judge_cli.py "맥북 250만원 사도 되나요"
    PYTHONIOENCODING=utf-8 python scripts/archive/cli/judge_cli.py "..." --사업명 예비창업패키지
    PYTHONIOENCODING=utf-8 python scripts/archive/cli/judge_cli.py "..." --org 1d6b...-c0838b431a7f
    PYTHONIOENCODING=utf-8 python scripts/archive/cli/judge_cli.py "..." --dry     # LLM 없이 배관만
    PYTHONIOENCODING=utf-8 python scripts/archive/cli/judge_cli.py "..." --json    # 기계용
