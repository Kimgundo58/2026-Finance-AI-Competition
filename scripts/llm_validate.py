...
═══ 층 B — 해야할일 설명 환각 대조 (2026-09-01 추가) ═══
    정본은 `프로토타입_해부_구현명세.md` §2-7. 키워드 2개가 늘었다:
...
# ════════════════════════════════════════════════════════════════════════════
# 층 B — 해야할일 설명 환각 대조. 정본은 `프로토타입_해부_구현명세.md` §2-7
# ════════════════════════════════════════════════════════════════════════════
...
#    설명이 비면 **판정 이전의 고정 문구로 폴백**한다. 기능을 죽이지 않으면서
...
def _출처숫자(*원천: str) -> set[str]:
    ...
    좁아서 나는 오폐기는 **정적 문구 폴백**이라 안전하다. 오답 비대칭 그대로다.
    """
    허용: set[str] = set()
    for s in 원천:
        허용 |= _숫자들(s)
